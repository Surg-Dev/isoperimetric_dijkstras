...
class NeckModel{
    public:
        ...
        std::vector<std::vector<Vertex>> neck_ratio_vertices_list; // List of vertices that make up the cycle at a max neck ratio
        std::vector<std::vector<Edge>> neck_ratio_cycle_list; // List of edges that make up the cycle at a max neck ratio
        std::vector<std::vector<Face>> neck_ratio_faces_list; // List of faces that make up the cycle at a max neck ratio
